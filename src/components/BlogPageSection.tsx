        ...
        <>
            <div className="max-w-screen-xl mx-auto px-5 pb-10">
                <div className="mx-auto max-w-3xl mt-14">
                    <span className="text-primary uppercase tracking-wider text-sm font-medium"> บทความแนะนำ </span>
                    ...
                    <div className="flex gap-2 mt-3 items-center flex-wrap md:flex-nowrap">
                        <span className="text-gray-400"><span className='sr-only'>ผู้เขียน</span> จิตสเตอร์ </span>
                        <span className="text-gray-400">•</span> <time className="text-gray-400" dateTime="2022-11-09T16:39:00.000Z"> 12 มกรา 2024 </time>
