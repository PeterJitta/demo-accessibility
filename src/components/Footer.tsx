...
const Footer = () => {
    return (
        <DIV htmlElement='footer' style="text-gray-600 w-full body-font">
                ...
                <div className='container flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col'>
                    <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left md:mt-0 mt-10">
                        <a className="flex  font-medium items-center md:justify-start justify-center text-gray-900">
                            ...
                            <span className="ml-3 text-xl">Meta Wealth</span>
                        </a>
                        <P defaultElement='p' style="mt-2 text-sm text-gray-500"> ผู้บริหารจัดการบัญชีกองทุนส่วนบุคคล Meta Wealth ที่ได้รับใบอนุญาตบริหารจัดการกองทุน </P>
                    </div>
            ...
            <div className="bg-gray-100">
                <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                    <P defaultElement='p' style="text-gray-500 text-sm text-center sm:text-left">© 2025 Meta Wealth
                    </P>
                    <span className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
                        ...
                        <a href="https://google.com" className="ml-3 text-gray-500">
                            <SVG width='20' height='20' title="click to visit x page">
                                <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
                        ...
                        <a href="https://google.com" className="ml-3 text-gray-500">
                            <SVG width='20' height='20' title="click to visit linkedin page">
